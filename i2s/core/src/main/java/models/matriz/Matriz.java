                ...
                if (c.match(cd)) {
                    ...
                    cdListReal.add(
                        new CelulaDetalhada(
                            ...
                            new Envolvente(ccDTO.getEnvolventeDTO().getTitulo(), ccDTO.getEnvolventeDTO().getDescricao()),
            ...
            for (CelulaBase c : celulas) {
                ...
                cbList.add(
                    new CelulaBase(
                        ...
                        new Envolvente(cDTO.getEnvolventeDTO().getTitulo(), cDTO.getEnvolventeDTO().getDescricao()),
