...
public class JSONImporter {
    ...
    public Caso importCaso(String filePath) throws Exception {
        ...
        // Estado do Caso
        EstadoCaso estado = EstadoCaso.valueOf((String) jsonObject.get(JSONSettings.CASO_ESTADO));

        List<ObjetoSeguro> objetoSeguroList = new ArrayList<>();

        JSONArray objectosSeguradosJSONArray = (JSONArray) jsonObject.get(JSONSettings.CASO_OBJECTOS_SEGURADOS);
